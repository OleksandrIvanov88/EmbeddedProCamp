...
/**
 * Given bl unit is initialized and fourth interrupt occurs
 * When timer counter set to not valid value  
 * Then error handler should be called
 */
void test_bl_error_handler(void)
{
    //arrange
    H_PioSwitchBlueLeds_Expect();
    ut_callback();
